...
const initSocket = (server) => {
  ...
  io.on(SOCKET_EVENT.CONNECTION, (socket) => {
    // event when host first create room
    ...
    // event after only two members in room
    ...
    // event when member leave room by unintended disconnection
